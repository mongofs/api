...
var file_im_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x47, 0x0a, 0x0e, 0x42, 0x72, 0x6f, 0x61,
	0x64, 0x63, 0x61, 0x73, 0x74, 0x42, 0x79, 0x57, 0x54, 0x49, 0x12, 0x1b, 0x2e, 0x69, 0x6d, 0x2e,
...
func (c *basicClient) BroadcastByWTI(ctx context.Context, in *BroadcastByWTIReq, opts ...grpc.CallOption) (*BroadcastReply, error) {
	out := new(BroadcastReply)
	err := c.cc.Invoke(ctx, "/im.basic.Basic/BroadcastByWTI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Basic_BroadcastByWTI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BroadcastByWTIReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BasicServer).BroadcastByWTI(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/im.basic.Basic/BroadcastByWTI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BasicServer).BroadcastByWTI(ctx, req.(*BroadcastByWTIReq))
	}
	return interceptor(ctx, in, info, handler)
}
